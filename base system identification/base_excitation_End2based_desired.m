...
%% Reading files
dir_date_str = 'base_final'; % Directory where the experimental data is
...
index_pole1      = find(freq_range_fit <= 16);
...
mass = ur5e_inertia_matrix_5kg(0,0*pi/9,-(k-1)*pi/9,0,0,0)
M11 = mass(1,1);
M12 = mass(1,2);
M22 = mass(2,2);
M23 = mass(2,3);
